...
char **merge_sort_strings(struct string_ptr_array_structure *const str_ptrs_arr,
                                                     const size_t max_str_len,
                                                     int (*const comparator_func)(const void *a, const void *b)) {

    assert(str_ptrs_arr != NULL);
...
void merge_sort_strings_splitting_in_half(const struct string_ptr_array_structure *const str_ptrs_arr,
                                                struct string_ptr_array_structure *const left,
                                                struct string_ptr_array_structure *const right) {
...
void merge_sort_strings_merging(struct string_ptr_array_structure *const str_ptrs_arr,
                                struct string_ptr_array_structure *const left,
                                struct string_ptr_array_structure *const right,
                                int (*const comparator_func)(const void *a, const void *b)) {
